...
import numpy as np
import gym
class BipedalBulletRLEnvFLAME5(BipedalBaseEnv):
    def __init__(self):
        self.robot = BipedalRobot2D(file_path="urdf/simbicon_urdf/flame5.urdf",delta_t=0.01)
