...
humanoid = p.loadURDF("/Users/pingy/PycharmProjects/flame_robot/urdf/simbicon_urdf/flame3.urdf", startPos, startOrientation, useFixedBase=1)
dt = 0.01
p.setGravity(0,0,-10)
p.setTimeStep(dt)
