...
if __name__ == "__main__":
    ...
    controller = multijointController(robot,"walkweight.csv")
    i=0
    time.sleep(2.0)
    while(robot.left_foot.state==0):
        robot.p.resetJointState(robot.humanoid, robot.left_hip.joint_id, -0.3)
    ...
    print("left leg hit ground,begin torque control!")
    while(i<100000):
