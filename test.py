...
class Actor(nn.Module):  # inherit from module class by nn module from pytorch

    def __init__(self, state_dim, action_dim, max_action):
        super(Actor, self).__init__()  # activate the inheritatance
...
class TD3(object):  # do not inherit from other class

    def __init__(self, state_dim, action_dim, max_action):  # create object
...
# env_name = "HumanoidPyBulletEnv-v0"  # Name of a environment (set it to any Continous environment you want)
env_name = "BipedalPyBulletEnv-v0"
